   ...
   <ul class="nav navbar-nav">
     ...
     <li><a href="../actualizar/actualizar.php">Actualizar Perfil</a></li>
				...
				<section class="content">
									...
									<div class="col-md-6">
										<div id="div_idcliente" class="form-group">
											...
											<select id="idcliente" name="vacante[idcliente]" class="form-control select2" style="width: 100%;" tabindex="1">
												...
												<?php
												$result= mysqli_query($con,"SELECT * FROM sab_vacantes WHERE idvacante='".$_GET['idvacante']."'");
												while($row=mysqli_fetch_array($result)){

													$res= mysqli_query($con,"SELECT * FROM sab_clientes");

													while ($rowc=mysqli_fetch_array($res)){

														if ($row['idcliente'] == $rowc['idcliente']) {
															echo '<option value="'.$rowc['idcliente'].'" selected>'.$rowc['nombre'].'</option>';
														}
														else {
															echo '<option value="'.$rowc['idcliente'].'">'.$rowc['nombre'].'</option>';
														}
													}
                      ...
                      <input name="foto" type="file" class="file" id='file' accept="image/*" />
									...
									<div class="col-md-6" >
										<div id="div_idReclutador" class="form-group">
											...
											<select id="idReclutador" name="vacante[idReclutador]" class="form-control select2" style="width: 100%;" tabindex="3">
												<option value="00" selected>Seleccione un Ejecutivo</option>
												<?php
												$resulr= mysqli_query($con,"SELECT * FROM sab_reclutadores WHERE idreclutador='".$idbusqueda."'");
													while($rowr= mysqli_fetch_array($resulr)) {
													   // echo $reclutador->idreclutado;
													    if ($row['idReclutador'] == $rowr['idreclutador']) {
															echo '<option value="'.$rowr['idreclutador'].'" selected>'.$rowr['nombre'].' '.$rowr['apellido_paterno'].' '.$rowr['apellido_materno'].'</option>';
														}
														else {
															echo '<option value="'.$rowr['idreclutador'].'">'.$rowr['nombre'].' '.$rowr['apellido_paterno'].' '.$rowr['apellido_materno'].'</option>';
														}
								...
								<div class="row">
									<div class="col-md-12">
										<div id="div_nombre" class="form-group">
											<label>Nombre</label>
											<input id="nombre" name="vacante[nombre]" type="text" class="form-control" style="text-transform: uppercase !important;" onchange="this.value=this.value.toUpperCase();" maxlength="200" autocomplete="off" value="<?= $row['nombre']; ?>" tabindex="2">
									...
									<div class="col-md-6">
										<div id="div_idcategoria" class="form-group">
											...
											<select id="idcategoria" name="vacante[idcategoria]" class="form-control select2" style="width: 100%;" onchange="carga_subcat('1');" tabindex="3">
												...
												<?php
												$resuc = mysqli_query($con,"SELECT * FROM sab_empleos_categorias");
													while($rowco = mysqli_fetch_array($resuc)) {
														if ($row['idcategoria'] == $rowco['idcategoria']) {
															echo '<option value="'.$rowco['idcategoria'].'" selected>'.$rowco['descripcion'].'</option>';
														}
														else {
															echo '<option value="'.$rowco['idcategoria'].'">'.$rowco['descripcion'].'</option>';
														}
													}
												?>
											</select>
								...
								<div class="row">
									<div class="col-md-6">
										<div id="div_idcategoria2" class="form-group">
											<label>Categoría</label>
											<select id="idcategoria2" name="vacante[idcategoria2]" class="form-control select2" style="width: 100%;" onchange="carga_subcat('2');" tabindex="3">
												<option value="00" selected>Seleccione una Categoría</option>
												<?php

												$resuc = mysqli_query($con,"SELECT * FROM sab_empleos_categorias");
													while($rowco = mysqli_fetch_array($resuc)) {
														if ($row['idcategoria2'] == $rowco['idcategoria']) {
															echo '<option value="'.$rowco['idcategoria'].'" selected>'.$rowco['descripcion'].'</option>';
														}
														else {
															echo '<option value="'.$rowco['idcategoria'].'">'.$rowco['descripcion'].'</option>';
								...
								<div class="row">
									<div class="col-md-6">
										<div id="div_idcategoria3" class="form-group">
											<label>Categoría</label>
											<select id="idcategoria3" name="vacante[idcategoria3]" class="form-control select2" style="width: 100%;" onchange="carga_subcat('3');" tabindex="3">
												<option value="00" selected>Seleccione una Categoría</option>
												<?php
												$resuc = mysqli_query($con,"SELECT * FROM sab_empleos_categorias");
													while($rowco = mysqli_fetch_array($resuc)) {
														if ($row['idcategoria3'] == $rowco['idcategoria']) {
															echo '<option value="'.$rowco['idcategoria'].'" selected>'.$rowco['descripcion'].'</option>';
														}
														else {
															echo '<option value="'.$rowco['idcategoria'].'">'.$rowco['descripcion'].'</option>';
								...
								<div class="row">
									<div class="col-md-12">
										<div id="div_descripcion_tareas" class="form-group">
											...
											<textarea id="descripcion_tareas" name="vacante[descripcion_tareas]" class="form-control" style="text-transform: uppercase !important;" onchange="this.value=this.value.toUpperCase();" rows="5" tabindex="5"><?= $row['descripcion_tareas']; ?></textarea>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div id="div_horario_laboral" class="form-group">
											...
											<input id="horario_laboral" name="vacante[horario_laboral]" type="text" class="form-control" style="text-transform: uppercase !important;" onchange="this.value=this.value.toUpperCase();" maxlength="45" placeholder="9:00 AM - 6:00 PM" value="<?= $row['horario_laboral']; ?>" autocomplete="off" tabindex="7">
								...
								<div class="row">
									<div class="col-md-4">
										<div id="div_salario" class="form-group">
											...
											<div class="input-group">
												<input id="salario" name="vacante[salario]" type="text" class="form-control" style="text-transform: uppercase !important; height: 35.5px !important;" onchange="this.value=this.value.toUpperCase();" maxlength="200" autocomplete="off" value="<?= $row['salario']; ?>" tabindex="9">
									...
									<div class="col-md-4">
										<div id="div_fecha_contratacion" class="form-group">
											...
											<input id="fecha_contratacion" name="vacante[fecha_contratacion]" type="text" class="form-control" autocomplete="off" tabindex="10" value="<?= date('d-m-Y', strtotime($row['fecha_contratacion'])); ?>" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask>
									...
									<div class="col-md-4">
										<div id="div_fecha_limite" class="form-group">
											...
											<input id="fecha_limite" name="vacante[fecha_limite]" type="text" class="form-control" autocomplete="off" tabindex="11" value="<?= date('d-m-Y', strtotime($row['fecha_limite'])); ?>" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask>
									...
									<div class="col-md-4">
										<div id="div_cantidad_vacantes" class="form-group">
											...
											<input id="cantidad_vacantes" name="vacante[cantidad_vacantes]" type="text" class="form-control" style="text-transform: uppercase !important;" onchange="this.value=this.value.toUpperCase();" maxlength="200" onkeypress="return soloNumeros(event)" value="<?= $row['cantidad_vacantes']; ?>" autocomplete="off" tabindex="11">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div id="div_edad_minima" class="form-group">
											...
											<input id="edad_minima" name="vacante[edad_minima]" type="text" class="form-control" style="text-transform: uppercase !important;" onchange="this.value=this.value.toUpperCase();" maxlength="200" onkeypress="return soloNumeros(event)" value="<?= $row['edad_minima']; ?>" autocomplete="off" tabindex="13">
									...
									<div class="col-md-4">
										<div id="div_edad_maxima" class="form-group">
											...
											<input id="edad_maxima" name="vacante[edad_maxima]" type="text" class="form-control" style="text-transform: uppercase !important;" onchange="this.value=this.value.toUpperCase();" maxlength="200" onkeypress="return soloNumeros(event)" value="<?= $row['edad_maxima']; ?>" autocomplete="off" tabindex="14">
				...
				<div class="box box-success">
					...
					<div class="box-body">
						<div class="row">
							...
							<?php
              $resuh= mysqli_query($con,"SELECT * FROM sab_habilidades");
							while($rowh=mysqli_fetch_array($resuh)){  ?>
							<div class="col-md-3">
								<div class="checkbox">
									<input type="checkbox" value="<?=$rowh['idhabilidad']?>" name="vacante[idhabilidades][]" id="<?=$rowh['idhabilidad']?>"/>
									<?php echo $rowh['descripcion']; ?>
								</div>
					...
					<div class="box-footer" align="right">
						<button type="button" class="btn btn-success" onclick="validar()" tabindex="18"><i class="fa fa-save"></i> &nbsp;Guardar</button>
					</div>
...
<script type="text/javascript">
	...
	<?php
		if(count($row['idhabilidades']) != 0){
			$habilidades = explode(',',$row['idhabilidades']);
	...
	<?php
		if ($row['nombre_cliente'] == "SI") {
	?>
		document.getElementById('nombre_cliente1').checked = true;
	<?php
		}
		else if ($row['nombre_cliente'] == "NO") {
	?>
	...
	<?php
		if ($row['ubicacion_cliente'] == "SI") {
	?>
		document.getElementById('ubicacion_cliente1').checked = true;
	<?php
		}
		else if ($row['ubicacion_cliente'] == "NO") {
	?>
	...
	<?php
		if ($row['licencia_conducir'] == "SI") {
	?>
		document.getElementById('licencia_conducir1').checked = true;
	<?php
		}
		else if ($row['licencia_conducir'] == "NO") {
	?>
	...
	<?php
		if ($row['disponibilidad_viajar'] == "SI") {
	?>
		document.getElementById('disponibilidad_viajar1').checked = true;
	<?php
		}
		else if ($row['disponibilidad_viajar'] == "NO") {
	?>
	...
	<?php
		if ($row['disponibilidad_residencia'] == "SI") {
	?>
		document.getElementById('disponibilidad_residencia1').checked = true;
	<?php
		}
		else if ($row['disponibilidad_residencia'] == "NO") {
	?>
	...
	<?php
		if ($row['personas_discapacidad'] == "SI") {
	?>
		document.getElementById('personas_discapacidad1').checked = true;
	<?php
		}
		else if ($row['personas_discapacidad'] == "NO") {
	?>
	...
	<?php
		if ($row['idcategoria'] != null || $row['idcategoria'] != '') {
	?>
		$.ajax({
			type: "post",
			...
			success: function(data) {
					...
					<?php
					if ( ($row['idcategoria_detalle'] != null || $row['idcategoria_detalle'] != '') && $row['idcategoria_detalle'] != 0) {
					?>
						$("#idcategoria_detalle").val("<?= $row['idcategoria_detalle']; ?>");
	...
	?>
	<?php
		if ($row['idcategoria2'] != null || $row['idcategoria2'] != '') {
	?>
		$.ajax({
			type: "post",
			data: { categoria : '<?= $row['idcategoria2']; ?>' },
			async: true,
			url: "subcategoria.php",
			cache: false,
			beforeSend: function(cargando) {
			...
			success: function(data) {
				if($("#idcategoria2").val() != '00'){
					...
					<?php
					if ( ($row['idcategoria_detalle2'] != null || $row['idcategoria_detalle2'] != '') && $row['idcategoria_detalle2'] != 0) {
					?>
						$("#idcategoria_detalle2").val("<?= $row['idcategoria_detalle2']; ?>");
					//	$("#idcategoria_detalle3").select4("val", "<?= $row['idcategoria_detalle2']; ?>");
					<?php
					}
					?>
				}
	...
	?>
	<?php
		if ($row['idcategoria3'] != null || $row['idcategoria3']!= '') {
	?>
		$.ajax({
			type: "post",
			data: { categoria : '<?= $row['idcategoria3']; ?>' },
			async: true,
			...
			success: function(data) {
				if($("#idcategoria3").val() != '00'){
					...
					<?php
					if ( ($row['idcategoria_detalle3'] != null || $row['idcategoria_detalle3'] != '') && $row['idcategoria_detalle3'] != 0) {
					?>
						$("#idcategoria_detalle3").val("<?= $row['idcategoria_detalle3']; ?>");
	...
	$("#jornada_laboral").select2("val", "<?= $row['jornada_laboral']; ?>");
	$("#tipo_contrato").select2("val", "<?= $row['tipo_contrato']; ?>");
	$("#experiencia").select2("val", "<?= $row['experiencia']; ?>");
	$("#estudios_minimos").select2("val", "<?= $row['estudios_minimos']; ?>");
	$("#idioma").select2("val", "<?= $row['idioma']; ?>");
	...
	function carga_subcat(numberCategoria) {
		...
		$.ajax({
			...
			success: function(data) {
				if(numberCategoria == '2'){
					$("#idcategoria_detalle2").empty().removeAttr("disabled").append(data);
					$("#idcategoria_detalle2").select2("val", "00");
				}else if(numberCategoria == '3'){
					$("#idcategoria_detalle3").empty().removeAttr("disabled").append(data);
					$("#idcategoria_detalle3").select2("val", "00");
				}else{
					$("#idcategoria_detalle").empty().removeAttr("disabled").append(data);
	...
	function validar() {
		...
		if ($("#fecha_limite").val() == '' || $("#fecha_limite").val() == null) {
			...
			$("#label_fecha_limite").empty().append('El campo Fecha de Contratación es requerido.');
		}
		else {
