...
";
?>
<br><img src='data:image/png;base64,<?php echo base64_encode($rowl['foto']); ?>' class='img-circle' alt='User Image' width='50px;' style='border:4px solid black; display:inline-block; margin-left: 60px;' >
<?php
 echo "
...
$result = mysqli_query($con,"SELECT * FROM `sab_vacantes` WHERE `estatus` = 'ACTIVA' AND idReclutador ='".$idbusqueda."'");
...
$result4 = mysqli_query($con,"SELECT idcategoria FROM sab_vacantes WHERE estatus = 'ACTIVA' AND idReclutador ='".$idbusqueda."' ");
   ...
   <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        <li class="active"><a href="reclutador.php">Home</a></li>
