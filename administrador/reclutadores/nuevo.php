 ...
 ?>
   ...
   <script>
    ...
    function registrarse(){
      ...
      if(user=="" || pass=="" || pass2=="" || nombre=="" || apellidop=="" || apellidom=="" || sexo==""){
      ...
      $.ajax({
            ...
            success:function(data){
              if(data==0){
                ...
                setTimeout("location.href='reclutadores.php'", 1000);
              }else if(data==1){
...
<div align='center'>
   ...
   <input name="nombre" type="text" id="nombre" class="nombre" placeholder="Escribe el nombre" /></p>
	 <p><h3>Apellido Paterno:</h3></p>
   <input name="apellidop" type="text" id="apellidop" class="nombre" placeholder="Escribe el apellido paterno" /></p>
	 <p><h3>Apellido Materno:</h3></p>
   <input name="apellidom" type="text" id="apellidom" class="nombre" placeholder="Escribe el apeliido materno" /></p>
	 <p><h3>Sexo:</h3></p>
	 <h2><input type="radio" name="sexo" value="H" /> Masculino</h2>
	 <h2><input type="radio" name="sexo" value="M" /> Femenino</h2>
   <br>
   <br>
