...
<section class="content">
  <a href="nuevo.php" class="agregar">Agregar Cliente</a>
  <br>
  <br>
  <div class="box">
      ...
      <table id="tabla_reclutadores" class="table table-bordered table-striped">
        ...
        <tbody>
          <?php
            ...
            while ($row = mysqli_fetch_array ($result)) {
              ...
              <?php
              echo "
         <form enctype='multipart/form-data' action='imagen.php?idvacante=".$row['idcliente']."' method='POST'>
        ...
        <input type='hidden' value='1' name='enviado' />
              ...
              title='Editar Vacante'
               href='editar.php?idvacante=".$row['idcliente']."'>
